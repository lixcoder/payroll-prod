                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h5 class="mb-0"><i class="feather icon-edit mr-2 text-primary"></i>Update Appraisal</h5>
                                        <small class="text-muted">Edit employee performance evaluation</small>
                                    </div>
                            ...
                            <div class="card-block">
                                ...
                                <form method="POST" action="{{ url('Appraisals/update/'.$appraisal->id) }}" class="modern-form">
                                    @csrf
                                    
                                    <input type="hidden" name="employee_id" id="employee_id" value="{{ $appraisal->employee->id }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="employee-display bg-light p-3 rounded">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h6 class="mb-0">{{ $appraisal->employee->first_name.' '.$appraisal->employee->middle_name.' '.$appraisal->employee->last_name }}</h6>
                                                            <small class="text-muted">Employee ID: {{ $appraisal->employee->id }}</small>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="p-3">
                                            <div class="form-group">
                                                ...
                                                <select name="appraisal_id" id="appraisal_id" class="form-control select2" required>
                                                    ...
                                                    @foreach($appraisalqs as $appraisalq)
                                                        <option value="{{ $appraisalq->id }}" 
                                                            data-maxscore="{{ $appraisalq->rate }}"
                                                            {{ $appraisal->appraisalquestion_id == $appraisalq->id ? 'selected' : '' }}>
                                                            {{ $appraisalq->question }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="performance" id="performance" class="form-control" required>
                                                    ...
                                                    <option value="Outstanding" {{ $appraisal->performance == 'Outstanding' ? 'selected' : '' }}>Outstanding</option>
                                                    <option value="Exceeds Expectations" {{ $appraisal->performance == 'Exceeds Expectations' ? 'selected' : '' }}>Exceeds Expectations</option>
                                                    <option value="Meets Expectations" {{ $appraisal->performance == 'Meets Expectations' ? 'selected' : '' }}>Meets Expectations</option>
                                                    <option value="Needs Improvements" {{ $appraisal->performance == 'Needs Improvements' ? 'selected' : '' }}>Needs Improvements</option>
                                                    <option value="Unsatisfactory" {{ $appraisal->performance == 'Unsatisfactory' ? 'selected' : '' }}>Unsatisfactory</option>
                                                    <option value="Not Applicable" {{ $appraisal->performance == 'Not Applicable' ? 'selected' : '' }}>Not Applicable</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-md-4">
                                                        <input class="form-control" placeholder="Score" type="number" name="score" id="score" value="{{ $appraisal->rate }}" min="0" required>
                                                    </div>
                                                    <div class="col-md-1 text-center">
                                                        <span class="text-muted">out of</span>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input class="form-control bg-light" readonly type="number" name="maxscore" id="maxscore" value="{{ App\Models\Appraisalquestion::getScore($appraisal->appraisalquestion_id) }}">
                                                    </div>
                                                    <div class="col-md-3">
                                    ...
                                    <div class="form-section mb-4">
                                        ...
                                        <div class="p-3">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" readonly type="text" name="examiner" id="examiner" value="{{ $user->username }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input class="form-control datepicker" readonly type="text" name="date" id="date" value="{{ $appraisal->appraisaldate }}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="comment" id="comment" rows="3" placeholder="Enter evaluation comments">{{ $appraisal->comment }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-actions text-right p-3 border-top">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="feather icon-save mr-1"></i> Update Appraisal
                                        </button>
                                    </div>
                                </form>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('form').on('submit', function(e) {
            ...
            // Basic validation
            $('#appraisal_id, #performance, #score, #date').each(function() {
                if (!$(this).val()) {
        ...
        // Initialize maxscore and percentage
        updateScorePercentage();
        validateScore();
    });
</script>
