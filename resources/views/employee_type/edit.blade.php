                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="mb-0"><i class="feather icon-edit mr-2 text-primary"></i>Update Employee Type</h5>
                                            <small class="text-muted">Modify existing employee type information</small>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ URL::to('employee_type/update/'.$etype->id) }}" class="modern-form">
                                        @csrf
                                            ...
                                            <div class="p-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" placeholder="Enter employee type name" type="text" name="name" id="name" value="{{ $etype->employee_type_name }}" required>
                                                    </div>
                                                    <small class="form-text text-muted">Update the name of the employee type</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-actions text-right p-3 border-top">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="feather icon-save mr-1"></i> Update Employee Type
                                            </button>
                                        </div>
                                    </form>
                                </div>
