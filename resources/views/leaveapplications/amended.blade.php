...
@section('xara_cbs')
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="mb-0"><i class="feather icon-edit-2 mr-2 text-warning"></i>Amended Leaves</h5>
                                            <small class="text-muted">View and manage amended leave applications</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="amendedLeavesTable" class="table table-hover table-striped">
                                            <thead>
                                                <tr>
                                                    <th>Employee #</th>
                                                    <th>Employee</th>
                                                ...
                                                @forelse($leaveapplications as $leaveapplication)
                                                    @if($leaveapplication->status == 'amended')
                                                        <tr>
                                                            ...
                                                            <td>{{ \Carbon\Carbon::parse($leaveapplication->date_amended)->format('M d, Y') }}</td>
                                                            ...
                                                            <td><span class="badge badge-warning">Amended</span></td>
                                                            <td>
                                                    ...
                                                    <tr>
                                                        <td colspan="9" class="text-center py-5">
                                                            <div class="empty-state">
                                                                <i class="feather icon-edit empty-state-icon" style="font-size: 48px; color: #dee2e6;"></i>
                                                                <h4 class="mt-3">No Amended Leaves</h4>
                                                                <p class="text-muted">There are no amended leave applications at this time.</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforelse
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#amendedLeavesTable').DataTable({
                responsive: true,
                pageLength: 10,
                order: [[3, 'desc']],
                language: {
                    search: "_INPUT_",
                    searchPlaceholder: "Search amended leaves...",
                    lengthMenu: "Show _MENU_ entries",
                    info: "Showing _START_ to _END_ of _TOTAL_ entries",
                    infoEmpty: "Showing 0 to 0 of 0 entries",
                    infoFiltered: "(filtered from _MAX_ total entries)",
                    emptyTable: "No amended leaves available",
                    paginate: {
