                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="mb-0"><i class="feather icon-edit mr-2 text-primary"></i>Edit Employee Court Order</h5>
                                            <small class="text-muted">Update court order assignment details</small>
                                        </div>
                                    ...
                                    <form method="POST" action="{{ url('employee_court_orders/'.$employeeCourtOrder->id) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="number" step="0.01" name="max_deduction" id="max_deduction" value="{{ $employeeCourtOrder->max_deduction }}" placeholder="0.00">
                                            </div>
                                        ...
                                        <div class="form-actions form-group">
                                            <button type="submit" class="btn btn-primary btn-sm">
                                                <i class="feather icon-check-circle mr-1"></i> Update Assignment
                                            </button>
                                        </div>
                                    </form>
                                </div>
