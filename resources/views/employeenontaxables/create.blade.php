                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="mb-0"><i class="feather icon-plus-circle mr-2 text-primary"></i>New Employee Non-Taxable Income</h5>
                                            <small class="text-muted">Create a new non-taxable income record</small>
                                        </div>
                                    ...
                                    <form method="POST" action="{{ URL::to('employeenontaxables') }}" accept-charset="UTF-8">
                                        ...
                                        <div class="form-actions form-group">
                                            <button type="submit" class="btn btn-primary btn-sm">
                                                <i class="feather icon-check-circle mr-1"></i> Create Non-Taxable Income
                                            </button>
                                        </div>
                                    </form>
                                </div>
