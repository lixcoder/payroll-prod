                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="mb-0"><i class="feather icon-plus-circle mr-2 text-primary"></i>New Deduction</h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ URL::to('deductions') }}" accept-charset="UTF-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Enter deduction name" type="text" name="name" id="name" value="{{ old('name') }}">
                                        </div>

                                        <div class="form-actions form-group">
                                            <button type="submit" class="btn btn-primary btn-sm">
                                                <i class="feather icon-check-circle mr-1"></i> Create Deduction
                                            </button>
                                        </div>
                                    </form>
                                </div>
