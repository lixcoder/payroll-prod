                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <small class="text-muted">
                                                Modify National Social Security Fund contribution rate
                                            </small>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ URL::to('nssf/' . $nrate->id) }}" accept-charset="UTF-8" id="nssfForm">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-actions mt-4">
                                            ...
                                            <a href="{{ URL::to('nssf') }}" class="btn btn-outline-secondary">
