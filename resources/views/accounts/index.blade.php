...
<div>
<h5 class="mb-0">
<i class="feather icon-layers mr-2 text-primary"></i>
Chart of Accounts
</h5>
<small class="text-muted">
Manage financial accounts for your organization
</small>
</div>
<div class="card-header-right">
<a href="{{ url('accounts/create') }}" class="btn btn-primary btn-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group" role="group">
                                                            <a href="{{ url('accounts/edit/'.$account->id) }}" 
