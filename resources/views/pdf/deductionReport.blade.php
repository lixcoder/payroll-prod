...
<body>
    ...
    <div class="title-section">
        ...
        @else
            <div class="report-title">DEDUCTION REPORT FOR {{ strtoupper($type) }}</div>
        @endif
            ...
            <tbody>
                ...
                @foreach($deds as $ded)
                    <tr>
                        ...
                        <td>
                            @if($ded->middle_name)
                                {{ $ded->first_name.' '.$ded->middle_name.' '.$ded->last_name }}
                            @else
                                {{ $ded->first_name.' '.$ded->last_name }}
                            @endif
                        </td>
                        @if($type == 'All')
                            <td>{{ $ded->deduction_name }}</td>
                        @endif
                        <td class="amount-cell">{{ asMoney($ded->deduction_amount) }}</td>
                    </tr>
                    <?php $i++; ?>
                @endforeach
