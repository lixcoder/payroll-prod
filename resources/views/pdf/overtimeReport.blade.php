...
<body>
    ...
    <div class="title-section">
        ...
        @else
            <div class="report-title">OVERTIME REPORT FOR {{ strtoupper($name) }}</div>
        @endif
            ...
            <tbody>
                ...
                @foreach($overtimes as $overtime)
                    <tr>
                        ...
                        <td>
                            @if($overtime->middle_name)
                                {{ $overtime->first_name.' '.$overtime->middle_name.' '.$overtime->last_name }}
                            @else
                        ...
                        @endif
                        <td class="amount-cell">{{ asMoney($overtime->overtime_amount) }}</td>
                    </tr>
                    <?php $i++; ?>
                @endforeach
