...
<body>
    ...
    <div class="title-section">
        @if($type == 'All')
            <div class="report-title">TAX RELIEF REPORT</div>
        @else
            <div class="report-title">TAX RELIEF REPORT FOR {{ strtoupper($type) }}</div>
        @endif
            ...
            <tbody>
                ...
                @foreach($reliefs as $relief)
                    <tr>
                        ...
                        <td>
                            @if($relief->middle_name)
                                {{ $relief->first_name.' '.$relief->middle_name.' '.$relief->last_name }}
                            @else
                                {{ $relief->first_name.' '.$relief->last_name }}
                            @endif
                        </td>
                        @if($type == 'All')
                            <td>{{ $relief->relief_name }}</td>
                        @endif
                        <td class="amount-cell">{{ asMoney($relief->relief_amount) }}</td>
                    </tr>
                    <?php $i++; ?>
                @endforeach
