...
<body>
    ...
    <div class="title-section">
        @if($type == 'All')
            <div class="report-title">NON-TAXABLE INCOME REPORT</div>
        @else
            <div class="report-title">NON-TAXABLE INCOME REPORT FOR {{ strtoupper($type) }}</div>
        @endif
            ...
            <tbody>
                ...
                @foreach($nontaxables as $nontaxable)
                    <tr>
                        ...
                        <td>
                            @if($nontaxable->middle_name)
                                {{ $nontaxable->first_name.' '.$nontaxable->middle_name.' '.$nontaxable->last_name }}
                            @else
                                {{ $nontaxable->first_name.' '.$nontaxable->last_name }}
                            @endif
                        </td>
                        @if($type == 'All')
                            <td>{{ $nontaxable->nontaxable_name }}</td>
                        @endif
                        <td class="amount-cell">{{ asMoney($nontaxable->nontaxable_amount) }}</td>
                    </tr>
                    <?php $i++; ?>
                @endforeach
