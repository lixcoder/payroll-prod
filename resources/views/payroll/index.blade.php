                                ...
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <small class="text-muted">Select period for payroll processing</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ URL::to('payroll/preview')}}" accept-charset="UTF-8" class="needs-validation" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
