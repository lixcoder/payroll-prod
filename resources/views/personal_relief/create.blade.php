                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="mb-0">
                                                ...
                                                Add New Personal Relief
                                            </h5>
                                            <small class="text-muted">
                                                Create a new tax personal relief amount
                                            </small>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ URL::to('personalrelief') }}" accept-charset="UTF-8" id="personalReliefForm">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
