                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="mb-0"><i class="feather icon-briefcase mr-2 text-primary"></i>Company Properties</h5>
                                <small class="text-muted">Manage company property assignments</small>
                            </div>
                            <div class="card-header-right">
                                <a href="{{ url('Properties/create')}}" class="btn btn-primary btn-sm">
                                    <i class="feather icon-plus mr-1"></i> New Property
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse($properties as $property)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        @else
                                                            {{ $property->first_name.' '.$property->middle_name.' '.$property->last_name }}
                                                        @endif
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-right">
                                                <span class="text-success font-weight-bold">{{ asMoney((double)$property->monetary) }}</span>
                                            </td>
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item text-primary" href="{{url('Properties/view/'.$property->id)}}">
                                                            <i class="feather icon-eye mr-2"></i> View Details
                                                        </a>
                                                        <a class="dropdown-item text-warning" href="{{url('Properties/edit/'.$property->id)}}">
                                                            <i class="feather icon-edit mr-2"></i> Update
                                                        </a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item text-danger" href="{{url('Properties/delete/'.$property->id)}}" 
                                            ...
                                            <td colspan="5" class="text-center py-5">
                                                <div class="empty-state">
                                                    <div class="empty-state-icon bg-light-primary">
                                                        <i class="feather icon-briefcase" style="font-size: 2.5rem; color: #7DA0B1;"></i>
                                                    </div>
                                                    <h4 class="mt-3">No Properties Assigned</h4>
                                                    <p class="text-muted">Get started by assigning company properties to employees.</p>
                                                    <a href="{{ url('Properties/create')}}" class="btn btn-primary mt-3">
                                                        <i class="feather icon-plus mr-1"></i> Assign First Property
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
