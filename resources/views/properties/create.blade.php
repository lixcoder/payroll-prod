                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="mb-0"><i class="feather icon-briefcase mr-2 text-primary"></i>Assign New Property</h5>
                                            <small class="text-muted">Create a new company property assignment</small>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ URL::to('Properties') }}" accept-charset="UTF-8" class="modern-form">
                                        @csrf
                                        ...
                                        <div class="form-section mb-4">
                                            ...
                                            <div class="p-3">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" placeholder="Enter property name" type="text" name="name" id="name" value="{{ old('name') }}" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                @endif
                                                                <input class="form-control" placeholder="0.00" type="text" name="amount" id="amount" value="{{ old('amount') }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="desc" id="desc" rows="3" placeholder="Enter property description">{{ old('desc') }}</textarea>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" placeholder="Enter serial number" type="text" name="serial" id="serial" value="{{ old('serial') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="dserial" class="font-weight-bold">Digital Serial Number</label>
                                                            <input class="form-control" placeholder="Enter digital serial" type="text" name="dserial" id="dserial" value="{{ old('dserial') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-section mb-4">
                                            ...
                                            <div class="p-3">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="issuedby" id="issuedby" value="{{ Auth::user()->username }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input class="form-control datepicker" type="date" name="idate" id="idate" value="{{ date('Y-m-d') }}" required>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input class="form-control datepicker" type="date" name="sdate" id="sdate" value="{{ date('Y-m-d') }}" required>
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text"><i class="feather icon-calendar"></i></span>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="form-group" id="receivedByGroup" style="display: none;">
                                                    ...
                                                    <input class="form-control" type="text" name="receivedby" id="receivedby" value="{{ Auth::user()->username }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-actions text-right p-3 border-top">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="feather icon-save mr-1"></i> Create Property Assignment
                                            </button>
                                        </div>
                                    </form>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('form').on('submit', function(e) {
                ...
                // Basic validation
                $('#employee_id, #name, #amount, #idate, #sdate').each(function() {
                    if (!$(this).val()) {
