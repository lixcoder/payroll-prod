                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ URL::to('allowances/update/'.$allowance->id) }}" accept-charset="UTF-8" id="allowanceForm">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <small class="form-text text-muted">
                                                        Update the allowance name as needed
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="{{ URL::to('allowances') }}" class="btn btn-outline-secondary">
